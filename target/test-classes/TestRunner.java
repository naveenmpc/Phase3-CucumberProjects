...
@CucumberOptions(features="C:\\Users\\mnave\\eclipse-workspace\\Lesson5-CucumberDemo\\src\\main\\java\\features",
				 glue= {"steps"},
				...
				// tags = "@test and @regression" // run scnearios having both the tags. but there is no test tag.. so it will not run it
				 ...
				 tags = "@all" // Now give the tag @register, you will observe before and after hook is executed
